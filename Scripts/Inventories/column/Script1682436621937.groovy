...
WebUI.click(findTestObject('Object Repository/Page_Inventory/button_Columns'))

WebUI.click(findTestObject('Object Repository/Page_Inventory/button_OK'))

WebUI.click(findTestObject('Object Repository/Page_Inventory/button_Columns'))

WebUI.click(findTestObject('Object Repository/Page_Inventory/button_Restore Defaults'))
