...
WebUI.setText(findTestObject('Page_Home/input_Cancel_select2-input select2-focused'), 'C H ROBINSON CO')

WebUI.click(findTestObject('Object Repository/Page_Home/body_var appList  nullfunction initLoad()co_aaa527'))

WebUI.click(findTestObject('Object Repository/Page_Home/body_var appList  nullfunction initLoad()co_aaa527_1'))
